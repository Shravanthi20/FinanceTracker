            ...
            <div className="hero-actions">
              {!isAuthenticated() ? (
                <>
                  ...
                  <Link className="button" to="/login" style={{ marginLeft: 8 }}>Login</Link>
                </>
              ) : (
                <>
                  <Link className="button" to="/upload">Import CSV/PDF</Link>
                  <Link className="button" to="/reports">View Reports</Link>
                  <Link className="button" to="/add-members">Manage Groups</Link>
                </>
              )}
            </div>
          </div>
